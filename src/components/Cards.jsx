        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-10 mt-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          {meals.map((meal) => (
            <div className="relative hover:scale-110 transition-all duration-1000">
              ...
              <div className="absolute inset-0 rounded-2xl opacity-0 hover:opacity-100 trancition-all duration-500 bg-[#83ba67]/85 flex flex-col justify-center items-center text-white font-bold gap-10">
